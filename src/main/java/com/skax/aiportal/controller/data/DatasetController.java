 ...
 * 
 * <p>
 * SKT AI 플랫폼의 데이터셋 관리 REST API를 제공하는 컨트롤러입니다.
 * 데이터셋의 생성, 조회, 수정, 삭제, 파일 업로드, 미리보기, 태그 관리 등의 기능을 제공합니다.
 * </p>
 * 
 * <p>
 * 주요 기능:
...
public class DatasetController {
     ...
     * 
     * <p>
     * 페이징, 정렬, 검색 조건을 적용하여 데이터셋 목록을 조회합니다.
     * 프로젝트별 필터링과 키워드 검색을 지원합니다.
     * </p>
     * 
     ...
     * @return 데이터셋 목록 응답
     */
    @Operation(summary = "데이터셋 목록 조회", description = "페이징, 정렬, 검색 조건을 적용하여 데이터셋 목록을 조회합니다.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "요청 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "400", description = "잘못된 요청 - 필수 파라미터 누락 또는 유효하지 않은 형식", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
    ...
    public ResponseEntity<CustomApiResponse<DatasetListRes>> getDatasets(
            ...
            @Parameter(description = "검색 키워드") @RequestParam(name = "searchKeyword", required = false) String searchKeyword) {
        ...
        log.info("데이터셋 목록 조회 시작: page={}, size={}, sortBy={}, projectId={}, searchKeyword={}", page, size, sortBy,
                projectId, searchKeyword);

        DatasetListRes response = datasetService.getDatasets(request);

        log.info("데이터셋 목록 조회 완료: totalCount={}, 처리시간={}ms", "N/A", response.getProcessingTimeMs());
     ...
     * <p>
     * 새로운 데이터셋을 생성합니다.
     * 데이터셋 메타데이터와 설정 정보를 포함하여 생성할 수 있습니다.
     * </p>
     * 
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "데이터 생성 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "400", description = "잘못된 요청 - 필수 파라미터 누락 또는 유효하지 않은 형식", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class)))
    })
    @PostMapping(consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<CustomApiResponse<DatasetCreateRes>> createDataset(
            @Parameter(description = "데이터셋 생성 요청 정보", required = true) @Valid @RequestBody DatasetCreateReq request) {
        ...
        log.info(LOG_DATASET_CREATE_SUCCESS, response.getDatasetId(), request.getName(),
     ...
     * 
     * <p>
     * 데이터셋 ID를 통해 특정 데이터셋의 상세 정보를 조회합니다.
     * 데이터셋의 모든 메타데이터와 설정 정보를 포함합니다.
     * </p>
     * 
     * @param datasetId 조회할 데이터셋의 고유 식별자
     * @return 데이터셋 상세 정보
     */
    @Operation(summary = "데이터셋 상세 조회", description = "데이터셋 ID로 특정 데이터셋의 상세 정보를 조회합니다.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "데이터셋 조회 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "404", description = "데이터셋을 찾을 수 없음", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class)))
    })
    ...
    public ResponseEntity<CustomApiResponse<DatasetGetRes>> getDatasetById(
            @Parameter(description = "조회할 데이터셋의 고유 식별자", required = true, example = "01803db6-24bd-4189-9ddd-9b6ca12c36fa") @PathVariable("datasetId") String datasetId) {
     ...
     * <p>
     * 기존 데이터셋의 정보를 수정합니다.
     * 이름, 설명, 상태, 태그 등의 메타데이터를 업데이트할 수 있습니다.
     * </p>
     * 
     ...
     * @return 수정된 데이터셋 정보
     */
    @Operation(summary = "데이터셋 정보 수정", description = "기존 데이터셋의 메타데이터 정보를 수정합니다.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "데이터셋 수정 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "400", description = "잘못된 요청 - 유효하지 않은 입력값", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "404", description = "데이터셋을 찾을 수 없음", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class)))
    })
    ...
    public ResponseEntity<CustomApiResponse<DatasetUpdateRes>> updateDataset(
            @Parameter(description = "수정할 데이터셋의 고유 식별자", required = true, example = "dataset-12345") @PathVariable("datasetId") String datasetId,

            @Parameter(description = "데이터셋 수정 요청 정보", required = true) @Valid @RequestBody DatasetUpdateReq updateRequest) {
     ...
     * <p>
     * 데이터셋을 삭제 상태로 표시합니다.
     * 실제 데이터는 삭제되지 않고 삭제 상태로 마킹되어 목록에서 제외됩니다.
     * </p>
     * 
     * @param datasetId 삭제할 데이터셋의 고유 식별자
     * @return 삭제 처리 결과
     */
    @Operation(summary = "데이터셋 삭제", description = "데이터셋을 삭제 상태로 표시합니다. (소프트 삭제)")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "데이터셋 삭제 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "404", description = "데이터셋을 찾을 수 없음", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class)))
    })
    ...
    public ResponseEntity<CustomApiResponse<DatasetDeleteRes>> deleteDataset(
            @Parameter(description = "삭제할 데이터셋의 고유 식별자", required = true, example = "dataset-12345") @PathVariable("datasetId") String datasetId) {
     ...
     * 
     * <p>
     * 삭제 상태로 표시된 모든 데이터셋을 완전히 제거합니다.
     * 이 작업은 되돌릴 수 없으므로 주의가 필요합니다.
     * </p>
     * 
     * @return 하드 삭제 처리 결과
     */
    @Operation(summary = "삭제된 데이터셋 하드 삭제", description = "삭제 상태인 모든 데이터셋을 완전히 제거합니다. 이 작업은 되돌릴 수 없습니다.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "하드 삭제 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class)))
    })
     ...
     * 
     * <p>
     * 파일을 직접 업로드하여 데이터셋을 생성합니다.
     * 지원되는 파일 형식에 따라 자동으로 데이터셋 타입이 결정됩니다.
     * </p>
     * 
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "데이터셋 생성 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "400", description = "잘못된 요청 - 파일 업로드 실패 또는 유효하지 않은 파일", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "422", description = "파일 검증 실패", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class)))
    })
     ...
     * 
     * <p>
     * 데이터셋의 일부 데이터를 미리보기로 조회합니다.
     * 지정된 청크 크기만큼의 데이터 샘플을 반환합니다.
     * </p>
     * 
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "미리보기 조회 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "400", description = "잘못된 요청 - 유효하지 않은 청크 크기", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "404", description = "데이터셋을 찾을 수 없음", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class)))
    })
     ...
     * 
     * <p>
     * 데이터셋의 태그 정보를 업데이트합니다.
     * 기존 태그를 대체하거나 새로운 태그를 추가할 수 있습니다.
     * </p>
     * 
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "태그 업데이트 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "400", description = "잘못된 요청 - 유효하지 않은 태그 정보", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "404", description = "데이터셋을 찾을 수 없음", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class)))
    })
     ...
     * 
     * <p>
     * 데이터셋에서 특정 태그들을 삭제합니다.
     * 지정된 태그만 제거하고 나머지 태그는 유지됩니다.
     * </p>
     * 
     ...
     */
    @Operation(summary = "데이터셋 태그 삭제", description = "데이터셋에서 특정 태그들을 삭제합니다.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "태그 삭제 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "400", description = "잘못된 요청 - 유효하지 않은 태그 정보", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "404", description = "데이터셋을 찾을 수 없음", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CustomApiResponse.class)))
    })
