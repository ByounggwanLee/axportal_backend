 ...
 * 
 * <p>SKT AI 플랫폼의 정책 관리 관련 API를 호출하는 Feign Client입니다.
 * 리소스 정책의 생성, 조회, 수정, 삭제 및 기본 정책 관리 기능을 제공합니다.</p>
 * 
...
public interface SktAiPolicyManagementClient {
     ...
     * 정책 유효성 검증
     * 
     * <p>정책 설정의 유효성을 검증합니다.</p>
     * 
     * @param policyPayload 검증할 정책 정보
     * @return 검증 결과
     */
    @PostMapping("/api/v1/auth/policy/validate")
