 ...
 * 
 * <p>
 * SKT AI 플랫폼의 역할 관리 관련 API를 호출하는 Feign Client입니다.
 * </p>
 * 
 ...
 * @version 1.0
 */
@FeignClient(name = "skt-ai-role", url = "${sktai.api.base-url:https://aip-stg.sktai.io}", configuration = com.skax.aiportal.client.sktai.config.SktAiClientConfig.class)
public interface SktAiRoleManagementClient {
     ...
     * @return 생성 결과
     */
    @PostMapping(value = "/api/v1/auth/role/default", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return 생성 결과
     */
    @PostMapping(value = "/api/v1/auth/role/sbn/{role_name}", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
