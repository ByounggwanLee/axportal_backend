 ...
 * 토큰 교환 응답 DTO
 * 
 * <p>토큰 교환 성공 시 반환되는 새로운 토큰 정보와 프로젝트 목록을 담는 DTO입니다.</p>
 * 
...
@AllArgsConstructor
@ToString
public class AuthTokenExchangeRes {

    /**
     * 교환된 액세스 토큰
     */
    @Schema(description = "교환된 액세스 토큰", example = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...")
     ...
     * 교환된 리프레시 토큰
     */
    @Schema(description = "교환된 리프레시 토큰", example = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...")
     ...
     * 교환된 대상 클라이언트 이름
     */
    @Schema(description = "교환된 대상 클라이언트 이름", example = "mobile-app")
