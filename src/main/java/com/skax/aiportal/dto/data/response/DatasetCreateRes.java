 ...
 * 데이터셋 생성 응답 DTO
 * 
 * <p>데이터셋 생성 요청에 대한 응답 정보를 담는 DTO입니다.
 * 생성된 데이터셋의 상세 정보와 처리 결과를 포함합니다.</p>
 * 
...
public class DatasetCreateRes {
     ...
     * 응답 상태 메시지
     */
    @Schema(description = "응답 처리 상태 메시지", example = "데이터셋이 성공적으로 생성되었습니다.")
    private String statusMessage;

    /**
     * 생성된 데이터셋 ID
     */
    @Schema(description = "생성된 데이터셋의 고유 식별자", example = "dataset-12345")
