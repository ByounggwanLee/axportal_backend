...
public class AuthService {
    ...
    private final Map<String, String> testUsers;
    private final Map<String, List<String>> userAuthorities;

    /**
     * 생성자에서 테스트용 사용자 데이터 초기화
     */
    public AuthService(JwtTokenProvider jwtTokenProvider, PasswordEncoder passwordEncoder) {
