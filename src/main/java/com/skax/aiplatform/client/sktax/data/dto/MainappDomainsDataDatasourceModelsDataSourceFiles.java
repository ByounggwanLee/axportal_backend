...
/**
 * 데이터소스 파일 모델 DTO (models 네임스페이스)
 * 
 * <p>데이터소스에 속한 파일의 상세 정보를 나타내는 모델입니다.
 * mainapp.domains.data.datasource.models 네임스페이스의 DataSourceFiles 스키마입니다.</p>
 * 
...
@NoArgsConstructor
@AllArgsConstructor
public class MainappDomainsDataDatasourceModelsDataSourceFiles {
