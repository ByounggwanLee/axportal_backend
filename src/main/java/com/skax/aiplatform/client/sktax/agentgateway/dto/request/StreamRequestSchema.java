...
/**
 * Agent Gateway Stream 요청 스키마
 * 
 * <p>Stream Request Schema for Swagger documentation.
...
@AllArgsConstructor
@Schema(
    description = "Stream Request Schema for Swagger documentation. This schema is for documentation purposes only.",
    example = "{\"config\":{},\"input\":{\"additional_kwargs\":{\"additional1\":\"value\"},\"messages\":[{\"content\":\"hello\",\"type\":\"human\"}]},\"kwargs\":{}}"
)
public class StreamRequestSchema {
